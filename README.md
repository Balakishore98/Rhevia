...
**2. Real audio.**
A proper per-input chain — gate, 8-band parametric EQ, compressor, de-esser,
limiter, bus sends — plus a **VST3 host** so every professional plugin in
existence works on day one. See [`docs/03-engine.md`](docs/03-engine.md#audio).
